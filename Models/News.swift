        ...
        if let imageURLs = news.newsImageURLs, !imageURLs.isEmpty {
            ...
            Task.detached(priority: .background) { [imageURLs] in
                ...
                for urlString in imageURLs {
                    if let url = URL(string: urlString) {
                        ...
                        do {
                            ...
                            print("Background media download failed for \(url): \(error)")
                        }
                    } else {
                        downloadedURLs.append(urlString)
                    }
                ...
                await MainActor.run { [downloadedURLs] in
                    ...
                    print("✅ Downloaded \(downloadedURLs.count) media items for news: \(newsId)")
                }
            }
        }
...
struct DummyLocalNews{
    static var News1 = LocalNews(id: "kodsfjojf", ownerUid: "lsdfjoasjjdwowjh", caption: "This is commented news", timestamp: Date.now, likesCount: 20, commentsCount: 10, postalCode: "560043", newsImageURLs: ["https://firebasestorage.googleapis.com:443/v0/b/localizer-5c786.firebasestorage.app/o/news_videos%2F652730B9-3B96-4082-A77D-F427596E48BC.mov?alt=media&token=ec63c602-29e5-4b73-8e1d-95237993f35d", "https://firebasestorage.googleapis.com:443/v0/b/localizer-5c786.firebasestorage.app/o/news_images%2F61085B46-E378-4B6A-A9FB-9C96AAFB55D0?alt=media&token=b18ae060-8171-414a-8c17-ddc2319b461f", "https://firebasestorage.googleapis.com:443/v0/b/localizer-5c786.firebasestorage.app/o/news_images%2F61085B46-E378-4B6A-A9FB-9C96AAFB55D0?alt=media&token=b18ae060-8171-414a-8c17-ddc2319b461f"], user: DummylocalUser.user1)
    ...
    static var News3 = LocalNews(id: "kodsfjojf", ownerUid: "lsdfjoasjjdwowjh", caption: "This is SavedNews", timestamp: Date.now, likesCount: 20, commentsCount: 10, postalCode: "560043", newsImageURLs: ["https://firebasestorage.googleapis.com:443/v0/b/localizer-5c786.firebasestorage.app/o/news_videos%2F652730B9-3B96-4082-A77D-F427596E48BC.mov?alt=media&token=ec63c602-29e5-4b73-8e1d-95237993f35d"], user: DummylocalUser.user1)
}
